...
const allowlist: AllowlistEntry[] = [
  ...
  // FNXC:EngineProcessRules 2026-09-06-00:00: re-pinned four drifted git-plumbing
  // call-sites (self-healing.ts 4313/4319/4356/13018 -> 4347/4353/4390/13052) after
  // commitOwnedByTask grew a campaign-controller-commit doc comment, an author param, and
  // author-fetching git log format changes at both findLandedTaskCommit call sites (all above
  // these sites). Verified as moves, not additions: each signature still occurs exactly once
  // in the file, the previously pinned lines now hold unrelated code (a destructured field, a
