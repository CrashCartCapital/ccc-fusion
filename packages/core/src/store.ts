...
/** non-string, empty, or whitespace value deletes that nodeId override, which */
  ...
  async cancelOrphanedWorkflowWorkItemIfExact(
    expected: Readonly<WorkflowWorkItem>,
  ): Promise<import("./task-store/task-mutation-ops.js").CancelOrphanedWorkflowWorkItemResult> {
    return cancelOrphanedWorkflowWorkItemIfExactImpl(this, expected);
  }
