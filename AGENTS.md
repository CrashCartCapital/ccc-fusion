...
- `PK-MCP` — MCP routing; trigger: MCP broker, MCP discovery, tool routing, mcpproxy, MCPJungle, tool_search, retrieve_tools, call_tool_read, call_tool_write, call_tool_destructive; cost: ~18993 B; read `packs/AGENTS.md/PK-MCP--routing.md`.
...
- `PK-CONSULT` — Consultation mechanics; trigger: consultation, review, agy-bridge, codex-mcp-server; cost: ~15047 B; read `packs/AGENTS.md/PK-CONSULT--consultation.md`.
- `PK-WORKFLOW` — Workflow procedures; trigger: plan, debug, research; cost: ~9189 B; read `packs/AGENTS.md/PK-WORKFLOW--procedures.md`.
...
- `PK-PROJECT-LOCAL` — ccc-fusion local guidance; trigger: project-local guidance; cost: ~19741 B; read `packs/AGENTS.md/PK-PROJECT-LOCAL--ccc-fusion.md`.
