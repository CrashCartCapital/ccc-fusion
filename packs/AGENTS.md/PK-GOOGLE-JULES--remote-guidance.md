...
- **Default** — Claude or Codex stays lead and reviewer: inspect the plan, full diff, changed interfaces, generated files, dependencies, and network and security posture, run the canonical local proof independently where practical, then follow up, reject, or merge. Merge mechanics and untrusted-PR handling follow [[30_DEVSTACK/instruction_system/components/_selected/Component-GitRepoManagement|Git Repo Management]].
